exports.run = async (client, message, [x, y, z]) => {
  if (!x || !y) { return message.channel.send("You need two numbers to multiply."); }
  ...
  if ((x === null) || (y === null) || (z === null)) { return message.reply("You are trying to multiply things that aren't numbers? Well no."); }
