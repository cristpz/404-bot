...
if(cmd === `${prefix}help`){
  ...
  .setColor("#3a0be7")
  .setThumbnail(bicon)
  .addField("Command Count", "171 currently")
  ...
  .addField("Fun", " `8ball` `cat` `dog` `google` `pick` `rate` `ratewaifu` `neko` `generateavatar` `yn` `lizard` `gasmoji` `coinflip` `define` `motivate` `meme` `shitpost` `emoji` `roll` ")
